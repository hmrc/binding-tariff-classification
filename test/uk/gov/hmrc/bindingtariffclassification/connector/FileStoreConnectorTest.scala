...
//import uk.gov.hmrc.bindingtariffclassification.base.{BaseSpec, BaseSpec2}
...
//
//class FileStoreConnectorTest extends BaseSpec2 with WiremockTestServer {
//
...
//
//  private val connector = new FileStoreConnector(config, mockHttpClient, new TestMetrics)
//
...
//      )
//
//      await(connector.find(FileSearch(ids = Some(Set("id"))), Pagination(1, 2))).results shouldBe
//        Seq(uploadedFile)
//
//      verify(
