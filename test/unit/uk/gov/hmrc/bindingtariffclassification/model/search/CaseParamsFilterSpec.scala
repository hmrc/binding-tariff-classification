...
class CaseParamsFilterSpec extends UnitSpec {


  "searchCase" should {

    // TODO : move tests to SearchCaseMapper
...
//
//      val actual = CaseParamsFilter(queueId = Some("valid_queue"), assigneeId = Some("valid_assignee")).buildJson
//
...
//        """.stripMargin.replaceAll(" ", "").replaceAll("\n", "")
//
//      val actual = CaseParamsFilter(queueId = Some(none_str), assigneeId = Some(none_str)).buildJson
//
//      actual.toString() shouldBe expected
//    }
//
...
//
//      val actual = CaseParamsFilter(reference = Some("valid_ref")).buildJson
//
...
//
//      val actual = CaseParamsFilter().buildJson
//
//      actual.toString() shouldBe "{}"
//    }
